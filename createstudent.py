    ...
    if(validateuserutil.checkuser(cnx,user)):
        ...
        if(validateuserutil.checkpassword(cnx,user,pwd)):
            ...
            if(validateuserutil.checkrole(cnx,user,'admin')):
                class_id=int(input('Enter the class id of the students:'))
                inputfile = input("enter the inputfile name including the extension containing student info of the class:")
                ...
                try:
                    ...
                    stdntinsertsql='insert into student_t (student_id,user_id,class_id,crt_dttm,upd_dttm) \
                                    values (%s,%s,%s,%s,%s)'
                    ...
                    for row in rows:
                        ...
                        stdntval=(user_id,user_id,class_id,formatted_date,formatted_date)
                        cursor.execute(stdntinsertsql,stdntval)
                ...
                print("You do not have privileges to create an student")
